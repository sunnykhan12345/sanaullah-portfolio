            ...
            <div className='md:container mx-auto px-5'>
                <div className='flex lg:flex-nowrap flex-wrap 2xl:gap-32 xl:gap-28 lg:gap-24 md:gap-12 gap-6'>
                    ...
                    <div className='lg:w-5/12 w-full 2xl:mt-16 lg:mt-12' data-aos="fade-up">
                        ...
                        <p className='text-half-black md:text-base text-sm md:mt-4 mt-2'>Feel free to reach out anytime! I am to respond to all messages within 24 hours on weekdays. Whether you have a project in mind or just want to say hello, I&#39;m here to chat and answer any questions you may have, thanks</p>
                       <div className='flex md:gap-4 gap-2 items-center md:mt-4 mt-2'>
                                <Link href="https://mailtoabdul24seven@gmail.com" target='_blank' className=' md:gap-2.5 gap-1.5   bg-half-black  md:w-10 w-7 md:h-10 h-7 flex justify-center items-center rounded-lg transition-all hover:scale-105 hover:bg-opacity-80 duration-500'>
