    ...
    return (
        <section className='xl:py-20 lg:py-16 md:py-12 py-8' id='projects'>
            <div className='md:container mx-auto px-5'>
                <h2 className='text-dark-black xl:text-4xl lg:text-3xl md:text-2xl text-xl uppercase font-semibold font-serif'data-aos="fade-down">Latest
                ...
                <div className='xl:mt-12 lg:mt-10 md:mt-8 mt-4 flex xl:gap-28 lg:gap-20 md:gap-8 gap-4 lg:flex-nowrap flex-wrap'>
                    <Link href="https://quadsol.co/" className='lg:w-5/12 w-full' data-aos="zoom-out">
                        <Image src="/images/quadsol.png" alt='quadruple' width={400} height={500} className='rounded-xl border-2 hover:border-orange transition-all duration-500 w-full' />
                    </Link>
                    <div className='lg:w-6/12 w-full flex flex-col justify-center'data-aos="zoom-in">
                        <h2 className='font-medium font-sans capitalize text-dark-black lg:text-3xl md:text-xl text-lg'>quadruple solutions</h2>
