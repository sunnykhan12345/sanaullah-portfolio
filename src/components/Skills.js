      ...
      <section className='xl:py-20 lg:py-16 md:py-12 py-8 bg-[#171717] bg-cover bg-skillbg lg:rounded-tl-[30px] lg:rounded-tr-[30px] rounded-tl-3xl rounded-tr-3xl' id='skills'>
        <div className='md:container mx-auto px-5'>
          ...
          <div className='grid lg:grid-cols-4 md:grid-cols-3 grid-cols-1 md:gap-4 gap-3 xl:mt-12 lg:mt-10 md:mt-8 mt-4'data-aos="zoom-in-up">
            ...
            {/* card 2 */}
            <Link href="https://www.w3schools.com/css/" target='blank' className='md:px-2 md:py-12 py-6 backdrop-blur-sm bg-[#68686833]/20 hover:bg-gradient-to-r from-yellow-100/20 to-red-300/20 border border-[#515262] duration-300 rounded-lg'>
            ...
            {/* card 3 */}
            <Link href="https://tailwindcss.com/docs/installation" target='blank' className='md:px-2 md:py-12 py-6 backdrop-blur-sm bg-[#68686833]/20 hover:bg-gradient-to-r from-yellow-100/20 to-red-300/20 border border-[#515262] duration-300 rounded-lg'>
            ...
            {/* card 4 */}
            <Link href="https://getbootstrap.com/docs/5.0/getting-started/introduction/" target='blank' className='md:px-2 md:py-12 py-6 backdrop-blur-sm bg-[#68686833]/20 hover:bg-gradient-to-r from-yellow-100/20 to-red-300/20 border border-[#515262] duration-300 rounded-lg'>
            ...
            {/* card 5 */}
            <Link href="https://react.dev/learn" target='blank' className='md:px-2 md:py-12 py-6 backdrop-blur-sm bg-[#68686833]/20 hover:bg-gradient-to-r from-yellow-100/20 to-red-300/20 border border-[#515262] duration-300 rounded-lg' >
            ...
            {/* card 6 */}
            <Link href="https://nextjs.org/docs" target='blank' className='md:px-2 md:py-12 py-6 backdrop-blur-sm bg-[#68686833]/20 hover:bg-gradient-to-r from-yellow-100/20 to-red-300/20 border border-[#515262] duration-300 rounded-lg'>
            ...
            {/* card 7 */}
            <Link href="https://www.w3schools.com/js/" target='blank' className='md:px-2 md:py-12 py-6 backdrop-blur-sm bg-[#68686833]/20 hover:bg-gradient-to-r from-yellow-100/20 to-red-300/20 border border-[#515262] duration-300 rounded-lg'>
