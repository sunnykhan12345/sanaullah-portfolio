...
const skillCategories = [
  ...
  // },
  {
    ...
    skills: [
      ...
      { name: "AWS (S3 Bucket)", icon: Cpu },
      { name: "VS Code", icon: Zap },
  ...
  },
  {
    ...
    skills: [
      { name: "MetaMask Integration", icon: Cpu },
      { name: "Smart Contracts", icon: Code },
      { name: "Ethereum (ETH)", icon: Database },
    ],
  },
];
