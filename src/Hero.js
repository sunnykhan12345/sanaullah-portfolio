      ...
      <div className='md:container mx-auto  px-5'>
        <div className='flex 2xl:gap-72 xl:gap-28 lg:gap-0 md:gap-10 gap-5  lg:flex-nowrap flex-wrap'>
          ...
          <div className='lg:w-7/12 w-full flex flex-col xl:mt-16 lg:mt-10 md:mt-6 mt-0' data-aos="zoom-in-down">
            ...
            <p className=' font-normal md:text-base text-sm text-half-black xl:w-11/12 lg:w-10/12 md:text-start text-center  lg:mt-8 md:mt-6 mt-2'>As a Front-End Developer, I have a demonstrated history of delivering high-quality, responsive, and interactive web applications. I specialize in Next.js, React, Tailwind CSS and JavaScript  backed by a solid foundation in HTML, CSS. My expertise enables me to create seamless user experiences while adhering to best practices in web development.</p>
